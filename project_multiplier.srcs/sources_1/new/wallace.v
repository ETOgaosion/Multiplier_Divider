...
module wallace(
    ...
    full_adder adder_l1_1 (.cin(N[ 4: 2]), .C(cout[4]), .S(layer_2_in[7]));
    full_adder adder_l1_2 (.cin(N[ 7: 5]), .C(cout[3]), .S(layer_2_in[8]));
    full_adder adder_l1_3 (.cin(N[10: 8]), .C(cout[2]), .S(layer_2_in[9]));
    full_adder adder_l1_4 (.cin(N[13:11]), .C(cout[1]), .S(layer_2_in[10]));
    full_adder adder_l1_5 (.cin(N[16:14]), .C(cout[0]), .S(layer_2_in[11]));
    assign layer_2_in[6] = N[1];
    ...
    // layer 2
    wire [5: 0]    layer_3_in;
    full_adder adder_l2_0 (.cin(layer_2_in[ 2: 0]), .C(cout[8]), .S(layer_3_in[2]));
    full_adder adder_l2_1 (.cin(layer_2_in[ 5: 3]), .C(cout[7]), .S(layer_3_in[3]));
    full_adder adder_l2_2 (.cin(layer_2_in[ 8: 6]), .C(cout[6]), .S(layer_3_in[4]));
    full_adder adder_l2_3 (.cin(layer_2_in[11: 9]), .C(cout[5]), .S(layer_3_in[5]));
    generate
